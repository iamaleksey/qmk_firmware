...
[_COLEMAK] = LAYOUT( \
  ...
  KC_ESC,   CTL_A,  ALT_R,   GUI_S,   SHFT_T,  KC_G,                      KC_M,    SFT_N,   GUI_E,   ALT_I,  CTL_O,  KC_QUOT, \
 ...
 */
  ...
  XXXXXXX , XXXXXXX,CG_TOGG, KC_WASD, XXXXXXX,  XXXXXXX,                     XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, XXXXXXX, XXXXXXX, \
